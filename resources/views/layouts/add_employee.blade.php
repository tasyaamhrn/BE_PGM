  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo me-5" href="{{asset('index.html')}}"><img src="{{asset('images/logo.svg')}}" class="me-2" alt="logo"/></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{asset('pages/icons/themify.html')}}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{asset('documentation/documentation.html')}}">
